        ...
        >
          ...
          <div className="glass rounded-3xl p-8 md:p-12 relative overflow-hidden">
            ...
            <p className="text-lg md:text-xl text-white/60 max-w-lg leading-relaxed font-light">
              Building scalable digital infrastructure with precision and aesthetic excellence.
            </p>
          </div>

          <div className="flex flex-wrap gap-4">
            <Button size="lg" className="rounded-full bg-white text-black hover:bg-gray-200 font-bold h-14 px-10">
              VIEW WORK <ArrowRight className="ml-2 w-4 h-4" />
            </Button>
            
            <Button size="lg" variant="outline" className="rounded-full border-white/20 text-white hover:bg-white/10 h-14 px-10 backdrop-blur-sm">
